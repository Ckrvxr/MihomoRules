...
const main = (config) => {
    ...
    config["rule-providers"] = {
        "DirectProcess": {
            ...
            "format": "yaml",
            "interval": 43200, // 12H
            "url": "https://fastly.jsdelivr.net/gh/Ckrvxr/MihomoYAML@main/Source/Addition/DirectProcess.yaml"
        },
        "AntiAntiFraud": {
            "type": "http",
            "behavior": "classical",
            "format": "yaml",
            "interval": 43200, // 12H
            "url": "https://fastly.jsdelivr.net/gh/Ckrvxr/MihomoYAML@main/Source/Addition/AntiAntiFraud.yaml"
        },
        "AntiPCDNFix": {
            "type": "http",
            "behavior": "classical",
            "format": "yaml",
            "interval": 43200, // 12H
            "url": "https://fastly.jsdelivr.net/gh/Ckrvxr/MihomoYAML@main/Source/Addition/AntiPCDNFix.yaml"
        },
        "AntiPCDN": {
            "type": "http",
            "behavior": "classical",
            "format": "yaml",
            "interval": 43200, // 12H
            "url": "https://fastly.jsdelivr.net/gh/Ckrvxr/MihomoYAML@main/Source/Addition/AntiPCDN.yaml"
        },
        "AWAvenue": {
            "type": "http",
            "behavior": "domain",
